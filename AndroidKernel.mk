...
ifeq ($(CONFIG_MACH_MATISSEWIFI_OPEN),y)
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8226/msm8226-sec-matissewifi-*.dts)
endif
ifeq ($(CONFIG_MACH_MATISSE3G_OPEN),y)
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8226/msm8226-sec-matisse3g-*.dts)
endif
ifeq ($(CONFIG_SEC_MATISSELTE_COMMON),y)
